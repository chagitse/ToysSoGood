...
namespace ToysSoGood
{
    public partial class SearchPage : System.Web.UI.Page
    {
        ...
        {
            //ומבצע שאילתא הטבלה שמוחזרת מוחזרת לתוך  הריפיטר url מקבל את שם הסרט משורת ה
            string movieName = Request.Params["value"];
            MovieRepeater.DataSource = prod.GetMoviesWithSearch(movieName);
        ...
        protected void OrderLink_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(string.Format("ShowProducts.aspx?value={0}", name));
        }
    }
}