<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Turn.aspx.cs" Inherits="ToysSoGood.Turn" %>
...
var jsVariable = <%= serializer.Serialize(arr) %>;
               
                var tmp = [];
                for (i = 0; i <4; i++)
                {
                    tmp.push({ id: 1, name: '<%= this.arr[x] %>' });
